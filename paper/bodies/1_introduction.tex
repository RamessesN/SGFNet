...
\begin{itemize}
  \item We propose SMCB to enhance semantic and contextual feature representations. Unlike conventional convolutions with spatially shared fixed kernels, our SMCB uses semantic-aware dynamic convolution to improve contextual dependency modeling.

  \item We introduce FMFB to alleviate the slight spatial misalignment. By performing adaptive cross-modal interaction in the frequency domain, our FMFB enhances complementary information integration. 
  
  \item Extensive experiments conducted on two benchmark datasets demonstrate that the proposed SGFNet consistently outperforms several state-of-the-art methods.
\end{itemize}
